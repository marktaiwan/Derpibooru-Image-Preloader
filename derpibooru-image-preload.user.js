...
(function() {
  ...
  function initCSS() {
    ...
    styleElement.id = `${SCRIPT_ID}-css`;
    styleElement.type = 'text/css';
    styleElement.innerHTML = `/* Generated by Marker's Derpibooru Image Preloader */
.${SCRIPT_ID}__main-switch, a.${SCRIPT_ID}__option, .${SCRIPT_ID}__option > * {
  cursor: pointer;
          user-select: none;
      -ms-user-select: none;
...
a.${SCRIPT_ID}__option.disabled, .${SCRIPT_ID}__option.disabled > * {
  cursor: default;
}`;
